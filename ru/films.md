...
3) Сожми MKV-файл с помощью программы [HandBrake](https://handbrake.fr/downloads.php). Я использую пресеты H.264 MKV. Перед запуском тщательно проверь аудио и субтитры. Если есть трек 5.1, он должен остаться 5.1 на выходе. Если HandBrake использует 100% CPU, Video->Advanced Options: ``threads=3``
<br><br>
