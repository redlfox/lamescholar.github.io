...
2) Bypass Paywall Clean, чтобы обойти пейволл
...
Распаковать. В хроме зайти в настройки расширений. Включить режим разработчика. Добавить распакованное расширение - папку.
...
В итоге бесплатный (не считая VPN) доступ к последним новостям из 400 источников.